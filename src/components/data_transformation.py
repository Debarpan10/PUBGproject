...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            numerical_cols = ['assists', 'boosts', 'damageDealt', 'DBNOs', 'headshotKills', 'heals',
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            target_column_name = 'winPlacePerc'
            drop_columns = [target_column_name,'Id','groupId','matchId','roadKills','teamKills','vehicleDestroys']
